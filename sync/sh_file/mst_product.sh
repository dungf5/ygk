#!/bin/bash
#mysqldump --defaults-extra-file=/var/tmp/sync/.mysql/.my.trans.cnf --single-transaction  master mst_product | mysql --defaults-extra-file=/var/tmp/sync/.mysql/.my.real.cnf ec_tmp
#kyou=`date`;
#echo $kyou."dump mst_product is finished"
