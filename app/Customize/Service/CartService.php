...
class CartService extends Service
{
     ...
     */
    public function addProductCustomize($ProductClass, $quantity = 1)
    {
    ...
    public function removeProductCustomize($ProductClass)
    {
        if (!$ProductClass instanceof ProductClass) {
            $ProductClassId = $ProductClass;
            $ProductClass = $this->entityManager
    ...
    {
        return $this->denyAccessUnlessGranted($attributes);
    }
}
