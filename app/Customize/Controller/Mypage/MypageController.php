...
//                $this->mailService->sendMailReturnProductPreview($email, $url_preview);
                ...
                if (!$param['returns_status_flag']) {
                    ...
                    $url_approve = $this->generateUrl('approve_login', [], UrlGeneratorInterface::ABSOLUTE_URL);
                    ...
                    $url_receipt = $this->generateUrl('approve_login', [], UrlGeneratorInterface::ABSOLUTE_URL);
        ...
        try {
            ...
            if ('POST' === $request->getMethod()) {
                ...
                if ($receipt == 'yes') {
                    ...
                    $url_return_receipt_finish = $this->generateUrl('approve_login', [], UrlGeneratorInterface::ABSOLUTE_URL);
