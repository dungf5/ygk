...
if (!class_exists('\Customize\Entity\DtOrderWSEOSDaitoTest', false)) {
    /**
     * DtOrderWSEOSDaitoTest
     *
     * @ORM\Table(name="dt_order_ws_eos_daito_test")
     * @ORM\Entity(repositoryClass="Customize\Repository\DtOrderWSEOSDaitoTestRepository")
     */
    class DtOrderWSEOSDaitoTest extends AbstractEntity
    {
        /**
