...
if (!class_exists('\Customize\Entity\DtBreakKeyDaitoTest', false)) {
    /**
     * DtBreakKeyDaitoTest
     *
     * @ORM\Table(name="dt_break_key_daito_test")
     * @ORM\Entity(repositoryClass="Customize\Repository\DtBreakKeyDaitoTestRepository")
     */
    class DtBreakKeyDaitoTest extends AbstractEntity
    {
        /**
         * @var string
         *
