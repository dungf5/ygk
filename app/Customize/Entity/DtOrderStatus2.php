...
if (!class_exists('\Customize\Entity\DtOrderStatus2', false)) {
    /**
     * DtOrderStatus2
     *
     * @ORM\Table(name="dt_order_status")
     * @ORM\Entity(repositoryClass="Customize\Repository\DtOrderStatus2Repository")
     */
    class DtOrderStatus2 extends AbstractEntity
    {
        /**
         * @var string
         *
