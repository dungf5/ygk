...
class DtOrderWSEOSDaitoTestRepository extends AbstractRepository
{
    /**
    ...
    {
        parent::__construct($registry, DtOrderWSEOSDaitoTest::class);
    }
    ...
    public function insertData($data = [])
    {
        try {
            ...
            $object = new DtOrderWSEOSDaitoTest();
