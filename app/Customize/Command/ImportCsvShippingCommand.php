...
/* Run Batch: php bin/console import-csv-shipping-command [param] */
class ImportCsvShippingCommand extends Command
{
    ...
    protected static $defaultName = 'import-csv-shipping-command';
    protected static $defaultDescription = 'Process Import Csv Shipping Command';
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        log_info('---------------------------------------');
        log_info('Start Process Import Csv Shipping');
        $param = $input->getArgument('arg1') ?? null;

        if (!$param) {
            log_error('No param. Process stopped.');

            $message = 'Process Import Csv Shipping. No param. Process stopped.';
        ...
        log_info('End Process Import Csv Shipping');
        //$io->success('End Process Import Csv Shipping');
