            ...
            foreach ($mstShippingWSEOS as $item) {
                try {
                    ...
                    $fields = [
                        ...
                        $item['delivery_no'],
                        $item['delivery_type'],
                        !empty($item['delivery_day']) ? date('Y/m/d', strtotime($item['delivery_day'])) : '',
                        ...
                        $item['tax_type'],
                        !empty($item['order_date']) ? date('Y/m/d', strtotime($item['order_date'])) : '',
                        !empty($item['shipping_date']) ? date('Y/m/d', strtotime($item['shipping_date'])) : '',
