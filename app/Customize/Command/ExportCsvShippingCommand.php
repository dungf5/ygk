            ...
            foreach ($mstShippingWSEOS as $item) {
                try {
                    ...
                    $fields = [
                        ...
                        mb_convert_encoding(!empty($item['order_date']) ? date('Y/m/d', strtotime($item['order_date'])) : '', 'Shift-JIS', 'UTF-8'),
                        mb_convert_encoding(!empty($item['shipping_date']) ? date('Y/m/d', strtotime($item['shipping_date'])) : '', 'Shift-JIS', 'UTF-8'),
