...
class ImportOrderDataCommand extends Command
{
    ...
    private function sendMailOrderSuccess()
    {
        ...
        // Information
        $information['subject_mail'] = '【ナチュラム】ご注文ありがとうございます';
        ...
        $order_success = [];
        $fusrdec1 = (int) (isset($this->customer['fusrdec1']) ? $this->customer['fusrdec1'] : 0);
        $fusrstr8 = (int) (isset($this->customer['fusrstr8']) ? $this->customer['fusrstr8'] : 0);
