...
use Eccube\Repository\SimNumberARepository;
...
//        try {
//
//            $this->SimNumber = $this->entityManager->getRepository(SimNumberARepository::class);
//            $simNumber= $this->SimNumber->find(1);
//            $simNumber->setPrice(222);
//            // Save account
//            $this->entityManager->persist($this->SimNumber);
